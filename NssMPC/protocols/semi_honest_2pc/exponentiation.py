...
def secure_exp(x: AdditiveSecretSharing) -> AdditiveSecretSharing:
    ...
    Args:
        x: The input ASS for which the exponential function is to be approximated.

    Returns:
        The approximation of :math:`e^x` based on the iterative limit.
