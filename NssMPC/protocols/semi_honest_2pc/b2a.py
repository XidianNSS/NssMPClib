...
def b2a(x: RingTensor, party: Party) -> AdditiveSecretSharing:
...
# todo: 输入应该为BSS
def sonic_b2a(x: RingTensor, party: Party | None = None) -> AdditiveSecretSharing:
...
def crypten_b2a(x: RingTensor, party: Party = None) -> AdditiveSecretSharing:
