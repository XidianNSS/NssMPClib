...
def secure_eq(x: AdditiveSecretSharing, y: AdditiveSecretSharing, party: Party = None) -> AdditiveSecretSharing:
    """
...
def msb_ge(x: AdditiveSecretSharing, y: AdditiveSecretSharing, party: Party = None) -> AdditiveSecretSharing:
    """
...
def dicf_ge(x: AdditiveSecretSharing, y: AdditiveSecretSharing, party: Party = None) -> AdditiveSecretSharing:
    """
...
def ppq_ge(x: AdditiveSecretSharing, y: AdditiveSecretSharing, party: Party = None) -> AdditiveSecretSharing:
    """
...
def sigma_ge(x: AdditiveSecretSharing, y: AdditiveSecretSharing, party: Party = None) -> AdditiveSecretSharing:
    """
...
class BooleanTriples(Parameter):
    ...
    def gen(num_of_triples: int, num_of_party: int = 2, type_of_generation: str = 'TTP',
            party=None) -> List['BooleanTriples'] | 'BooleanTriples':
        """
    ...
    @classmethod
    def gen_and_save(cls, num: int, saved_name: str = None, num_of_party: int = 2, saved_path: str = None,
        ...
        Examples:
            >>> BooleanTriples.gen_and_save(100)
        """
