...
trainset = torchvision.datasets.MNIST(root='data/neural_network', train=True, download=True,
                                      transform=transform)

trainloader = torch.utils.data.DataLoader(trainset, batch_size=100, shuffle=True,
                                          num_workers=0)

testset = torchvision.datasets.MNIST(root='data/neural_network',
...
path = 'data/neural_network/AlexNet'
