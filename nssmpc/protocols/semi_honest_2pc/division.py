...
def sh2pc_div(x: AdditiveSecretSharing, y: AdditiveSecretSharing,
...
def sh2pc_inv(x: AdditiveSecretSharing) -> AdditiveSecretSharing:
    r"""Securely computes the multiplicative inverse (reciprocal) :math:`1/x`.
