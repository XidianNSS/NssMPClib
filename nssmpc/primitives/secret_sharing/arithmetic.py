...
class AdditiveSecretSharing(SecretSharingScheme):
    ...
    def recon_from_shares(share_0, share_1):
        """Reconstruct the original data from two ASS instance(or we could say two shares).
        ...
        Examples:
            >>> res = AdditiveSecretSharing.recon_from_shares(s0, s1)
        """
...
class ReplicatedSecretSharing(SecretSharingScheme):
    ...
    @staticmethod
    def gen_and_share(r_tensor: RingTensor, party: Party3PC):
        ...
        Args:
            ...
            party (Party3PC): The party that holds the RingPair.
    ...
    @staticmethod
    def reshare(value: RingTensor, party: Party3PC):
        ...
        Args:
            ...
            party (Party3PC): The party that holds the share.
    ...
    @classmethod
    def random(cls, shape, party: Party3PC = None):
        ...
        Args:
            ...
            party (Party3PC): The party that holds the random RSS.
    ...
    @classmethod
    def rand_like(cls, x, party: Party3PC = None):
