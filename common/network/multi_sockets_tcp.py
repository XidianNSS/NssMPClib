...
from config.network_configs import SOCKET_MAX_SIZE, SOCKET_NUM
...
class TCPServer(object):
    ...
    def start_listening(self, server_idx, world_size):
        ...
        while True:
            ...
            try:
                ...
                self.socket_mapping[server_idx][client_address] = client_socket
                self.connect_number += 1
                if len(self.socket_mapping[server_idx]) == world_size - 1:
                    break
