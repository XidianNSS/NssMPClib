...
class TestParty0(unittest.TestCase):
    ...
    def test_inv_sqrt(self):
        ...
        res_share_z = torch.max((torch.rsqrt(y)) - share_z.recon().convert_to_real_field())
